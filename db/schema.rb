...
ActiveRecord::Schema.define(version: 20141008075817) do
  ...
  create_table "users", force: true do |t|
    ...
    t.boolean  "gets_mention_emails",      default: false, null: false
    t.boolean  "gets_question_emails",     default: false, null: false
  end
